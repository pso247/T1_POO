 ...
 * ║   Técnicas de Programación Orientada a Objetos – T1 Primera Evaluación   ║
 * ║   Universidad Privada del Norte                                           ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Temas del sílabo aplicados:
 *   Semana 1: Clases, objetos, atributos, métodos, modificadores de acceso.
 *   Semana 2: Parámetros, sobrecarga, static, colecciones (ArrayList), manejo
 *             de errores.
 *   Semana 3: Requerimientos, historias de usuario, diagrama UML, relaciones
 *             entre clases (Asociación, Agregación, Composición, Dependencia).
 *
 * Diagrama UML implementado:
 *   Inventario  ──(Agregación)──►  Producto
 *   Producto    ──(Composición)──► Categoria
 *   Proveedor   ──(Asociación)───► Producto
 *   MovimientoStock ──(Dependencia)──► Producto
 *   Inventario  ──(Composición)──► MovimientoStock
 */
public class Main {
