 ...
 * Registra las entradas y salidas de unidades de un producto.
 *
 * Relaciones (según diagrama UML del Caso 3):
 *   - Dependencia con Producto   → necesita un Producto para existir.
 *   - Composición con Inventario → no tiene sentido fuera del inventario.
 *
 * Semana 2: Modificador estático (contador de IDs), manejo de errores, colecciones.
 * Semana 3: Relación de dependencia y composición (UML).
 */
public class MovimientoStock {

    // ── Constantes de tipo (modificador static final – Semana 2) ─────────────
    public static final String ENTRADA = "ENTRADA";
    public static final String SALIDA  = "SALIDA";

    // ── Contador estático para auto-generar IDs (clase estática – Semana 2) ───
    ...
    // Dependencia: referencia al Producto involucrado en el movimiento
    ...
    /**
     * Registra el movimiento actualizando el stock del producto (RF-02).
     * Aplica validación: no permite salida si el stock es insuficiente.
     */
