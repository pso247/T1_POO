...
/**
 * Clase Producto
 * Representa un artículo del inventario con su información completa.
 *
 * Relaciones (según diagrama UML del Caso 3):
 *   - Composición   con Categoria  → el producto "tiene" una categoría obligatoria.
 *   - Asociación    con Proveedor  → puede tener varios proveedores (ArrayList).
 *
 * Semana 1-2: Clases, atributos, métodos, encapsulamiento, modificadores de acceso.
 * Semana 2  : Colecciones (ArrayList de proveedores), manejo de errores.
 * Semana 3  : Relaciones UML aplicadas al diseño de clases.
 */
public class Producto {
    ...
    // ── Setters con validación (manejo de errores – Semana 2) ─────────────────
    ...
    /**
     * Agrega un proveedor a la lista del producto (Asociación N-N).
     */
